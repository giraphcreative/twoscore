...
var contact_submit = function( form ) {
	...
	var field = {
			...
			cu_name: $( form ).find( "input[name=cu-name]" ).val(),
	...
	// check the names
	if ( field.fname.length < 2 ) {
		errors.push( "Please provide a first name." );
	}
	if ( field.lname.length < 2 ) {
...
$(document).ready(function(){
	...
	// intercept form submissions, and check field values before sending.
